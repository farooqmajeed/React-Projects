...
var Generate=require( './generatePassword.js');
...
var Password = React.createClass({
  ...
  generate: function(){
    var _this = this
     this.setState({visible: true, password: Generate.generatePassword()}, function(){
  ...
  render: function(){
    ...
    return (
      <div className="well form-group-default col-md-6">
